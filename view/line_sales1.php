...
?>
   <tr class="table_row" style="cursor: pointer;">
     ...
     <td > <a href="../forms/add_staff_grv.php?sales_id=<?php echo $sales_id;?>"> <?php echo $sales_date; ?> </a></td>
            <?php
...
?>
  <tr class="table_summary" >    
    ...
    ?></tr>
    <tr class="table_summary" ><th colspan="3">TOTAL AMOUNT </th> <?php for ($i=1;$i<=$total_article;$i++){?> <td> <?php echo $sum[$i]*$sales_price[$i];   ?>   </td>    <?php }    ?></tr> 
      <tr class="table_summary" ><th colspan="3">TOTAL GST/TAX </th> <?php for ($i=1;$i<=$total_article;$i++){?> <td> <?php echo $sum[$i]*$tax[$i];   ?>   </td>    <?php }    ?></tr>  
     <tr class="table_summary" ><th colspan="3">TOTAL COST </th> <?php for ($i=1;$i<=$total_article;$i++){?> <td> <?php echo $sum[$i]*$article_price[$i];   ?>   </td>    <?php }    ?></tr>  
