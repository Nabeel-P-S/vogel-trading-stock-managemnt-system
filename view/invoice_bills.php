...
<div id="printableArea"  class="col-md-12" >
      ...
      <h3 style="text-align: center;"><b>INVOICE STATEMENT  </b></h3>
...
<td style="text-align: center;" >amount (In gst)</td>
     <?php
...
?>
   <tr class="table_row" style="cursor: pointer;">
         <td > <a href="../print/invoice_bill.php?sales_id=<?php echo $sales_id;?>"> <?php echo $invoice_no; ?> </a></td>
 ...
 for ($i=1;$i<=$total_article;$i++)
        {
          ...
          <td>
          <?php
              $query2=mysqli_query($conn,"SELECT article_qty from sales_articles  WHERE sales_id='$sales_id' AND article_id='$i'");
...
$count++;
         ...
         <tr class="table_row">
          ...
          <td> <?php echo round($article_mrp,2); ?></td>
...
<tr style="color: red;">
  ...
  <td style="font-weight:bold;"><?php echo vround($order_mrp);?></td>
</tr>
<?php 
