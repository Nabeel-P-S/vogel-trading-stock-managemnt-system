...
<body>
  ...
  <div class="col-lg-12" style="background-color: #333;margin-bottom: 2vw;">
     <!-- <a class="w3-bar-item w3-button w3-hover-green navoption"  href="http://localhost/stock/home.php">STOCK</a> -->
 
   <!-- <a class="w3-bar-item w3-button w3-hover-red navoption"  href="../staff/home.php">STOCK</a> -->
   <a class="w3-bar-item w3-button w3-hover-green navoption" href="../staff/home1.php" > ADD ESTIMATION BILL   </a>
   <a class="w3-bar-item w3-button w3-hover-yellow navoption" href="../staff/est_bills.php" > VIEW ESTIMATION BILLS   </a>
    <!-- <a class="w3-bar-item w3-button w3-hover-yellow navoption" href="../staff/home2.php" > INVOICE BILL  </a> -->
