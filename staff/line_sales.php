...
<body>
  ...
  <div class="col-lg-12" style="background-color: #333;">
   ...
   <a class="w3-bar-item w3-button w3-hover-green navoption" href="../staff/home1.php" > ESTIMATION BILL   </a>
   <a class="w3-bar-item w3-button w3-hover-green navoption" href="../staff/line_sales.php" > VIEW ESTIMATION BILLS   </a>
