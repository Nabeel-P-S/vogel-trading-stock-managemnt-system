...
<!-- <div  style="float:left;width: 50%;border-right: 1px;">  -->
  ...
  <table border="0" style="margin-left: 5px;">
       ...
       <tr><td style="width: 15vw;">GRV DATE :</td><td><b> <?php echo $grv_date;?></b></td><td colspan="2" style="border-left: 1px solid;padding-left: 40px;"><b></b>  </td></tr>
     <tr><td style="width: 25vw;">INVOICE NO :</td><td><b> </td><td colspan="2" style="border-left: 1px solid;padding-left: 40px;"></td></tr>
