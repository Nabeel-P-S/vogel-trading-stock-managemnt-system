...
include('../print/estimation_details.php'); 
...
<b style="margin-left: 30vw;font-size: 2vw;color: YELLOW;background-color: brown;">STAFF GOODS RETURN </b>
<tr>
  <td>
    ...
    <input id="grv_date" type="date"  class="form-control" name="grv_date" value="<?php echo $date ?>"  >
  </div>
  </td>
  <td>
 <div class="input-group">
    <span class="input-group">INVOICE NO</span>
    <input id="sales_invoice_no" type="text" class="form-control" value="<?php echo $sales_id ?>" name="invoice_no" >
...
<td>
 <div class="input-group">
   ...
   <input value="<?php echo $staff_name ?>" id="staff_name" readonly="1" class="form-control" name="staff_name" placeholder="SEARCH STAFF" >
   <input value="<?php echo $staff_id?>" id="staff_id" type="hidden" class="form-control" name="staff_id" placeholder="SEARCH STAFF" >
...
<td style="display:none;color: blue;float: right;"><b >MARGIN</b> </td>
<td style="display: none;color: blue;" colspan="0"> <input id="profit_total" value="<?php echo $profit;?>" style="color: blue;font-weight: bold;" readonly="1" name="profit" class="form-control">
</td>

<td > <input id="cost_total" style="display:none;color: green;" readonly="1" name="cost_total" class="form-control" >
</td>
<td><legend>TOTAL </legend></td>
<td colspan="2"> <input id="sales_total" style="color: red;font-weight: bold;font-size: 1.5vw;" readonly="1" value="<?php echo $sales;?>"  name="sales_total" class="form-control" >
</td>
  ...
  <div >
    ...
    <button  style="float: right;" onclick="save_staff_grv()" class="btn btn-danger">SAVE GRV</button>
...
<script>
      ...
      <script type="text/javascript">
function save_staff_grv()
{
 var article_element=document.getElementsByName('sales_article_id');
 var item_qnty1_element=document.getElementsByName('item_qnty1');
 ...
 var grv_date=document.getElementById("grv_date").value;
 var article_array=[];
 var item_qnty1=[];
 var n=0;
 for (var i = 0; i <article_element.length; i++) 
 {
   ...
   var item_qnty1_id=item_qnty1_element[i].value;
   
   if (article_id!=""&&item_qnty1_id!=""&&item_qnty1_id!=0)
   {

    article_array[n]=article_id;
    item_qnty1[n]=item_qnty1_id;
    n++;
  }
}

var article_array_json=JSON.stringify(article_array);
var item_qnty1_json=JSON.stringify(item_qnty1);
        ...
        $.ajax( 
            {  
              ...
              type:"POST",
              url:"../insert/staff_grv_insert.php",
              // dataType:"json",
              data:{
               article_array_json:article_array_json,
               item_qnty1_json:item_qnty1_json, 
               grv_date:grv_date,
