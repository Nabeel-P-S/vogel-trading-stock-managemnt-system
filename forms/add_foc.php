...
<!-- Form Name -->
<legend>ADD  FOC    <p style="float: right;">No : <?php echo $foc_id ?> </p> </legend>    
...
<tr>
  <td>
    ...
    <span class="input-group">FOC DATE</span>
 ...
 <div class="input-group">
    ...
    <input id="sales_invoice_no" type="text" class="form-control" readonly="1" value="<?php echo $foc_id ?>" name="invoice_no" >
  </div>
  </td>
...
<td><div class="input-group" >
   ...
   <input list="staffs" id="staff_id" class="form-control" name="staff_id" value="VOGEL" readonly="1" placeholder="SEARCH STAFF" >
<datalist id="staffs">
...
<tr><td colspan="6">   <label style="float: right;">PAID AMOUNT</label>     </td><td colspan="3"><input class="form-control" id="paid" type="text"   placeholder="PAID AMOUNT" name="paid" ></td></tr>
  ...
  <div >
    ...
    <button  onclick="save_sales()" style="width: 20vw;margin-left: 20vw;background-color: black;" class="btn btn-success">SAVE THIS INVOICE BILL</button>
...
function save_sales1(customer_id)
{
   ...
   if (staff_id==""||sales_total=="")
      ...
      {   alert("foc added successfully"); 
        
        $.ajax( 
                     { 

                     type:"POST",
                     url:"../insert/foc_insert.php",
                     dataType:"json",
                     data:
                        {
