...
<b style="animation:forwards 5s infinite;margin-left: 30vw;font-size: 2vw;color: black;*background-color: brown;">GOODS RETURN VALUE</b>
<tr>
  <td>
 ...
 <div class="input-group">
    ...
    <input id="sales_invoice_no" type="text" onchange="new_grv(this.value);" class="form-control" value="<?php echo $invoice_no ?>" name="invoice_no" >
...
<td > <input id="sales_total" style="color: red;font-weight: bold;" readonly="1" value="<?php echo $sales;?>"  name="sales_total" class="form-control" >
  ...
  <div >
    ...
    <span>PAID</span>     <input id="paid" type="text"   value="<?php echo $paid;?>" name="paid" >
    <span>BALANCE</span>     <input id="paid" type="text"   value="<?php echo $sales-$paid;?>" name="paid" >
    <button  style="float: right;" onclick="save_grv()" class="btn btn-danger">SAVE GRV</button>
...
<script type="text/javascript">
	function new_grv(invoice_no)
	{
		window.location="add_grv.php?invoice_no=" + invoice_no;
	}
</script>
